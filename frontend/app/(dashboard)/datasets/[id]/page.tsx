...
import { useDatasetData } from '@/lib/hooks/queries/use-dataset-data'
...
export default function DatasetDetailPage() {
    ...
    const {
        ...
        error: dataError,
    } = useDatasetData(datasetId, { page: currentPage, limit: pageSize })
    ...
    const handleExport = async () => {
        try {
            const blob = await datasetsApi.exportDataset(datasetId)
     ...
     */
    const handleJoin = () => {
        router.push(`/datasets/join?base=${datasetId}`)
    }

    const totalPages = datasetData ? Math.ceil(datasetData.total / pageSize) : 1
            ...
            <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        {metadataError?.message || dataError?.message || 'An error occurred'}
                    </p>
                </div>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-semibold mt-1">{fileSizeMb} MB</p>
                            </div>
                            <div>
                ...
                <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-normal text-gray-600 dark:text-gray-400">
                            ({datasetData?.total.toLocaleString() || 0} rows)
                        </span>
                    </CardTitle>
                </CardHeader>
                <CardContent>
